...
const Hero = () => {
  return (
    <section
      id="hero"
      className="bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 text-white flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-12 py-24 sm:py-16 md:py-20 lg:py-28 max-w-7xl mx-auto"
    >
      {/* Left Text */}
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-snug">
          Grow Taller Naturally – <br className="hidden sm:block" />
      ...
      <div className="w-full md:w-1/2 mt-10 md:mt-0 flex justify-center">
        <img
          ...
          className="w-40 sm:w-56 md:w-72 lg:w-[24rem] max-w-full rounded-xl shadow-2xl object-contain"
          loading="lazy"
        />
      </div>
    </section>
